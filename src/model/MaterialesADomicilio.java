...
public class MaterialesADomicilio {
    ...
    /**
     * Solicita Ingresar al usuario el tammaño de materiales o productos
     * <b> Pre: Scanner creado(in). </b>
     * <b> Post: La cantidad de materiales o productos. </b>
     * @param in
     * @return
     */
    ...
    /**
     * Solicita al usuario ingresar los nombres de los materiales
     * <b> Pre: Cantidad de materiales o productos(productsSize) y  el Scanner creado (in). </b>
     * <b> Post: Los nombres de cada material. </b>
     * @param productsSize
     * @param in
     * @return
     */
    ...
    /**
     * Solicita al usuario ingresar la cantidad de cada material
     * <b> Pre: Cantidad de materiales ingresada.</b> 
     * <b> Post: . </b>
     * @param productsSize
     * @param in
     * @return
     */
    public static int[] solicitateProductsAmount(int productsSize, Scanner in) {
        int[] productsAmount = new int[productsSize];
     ...
     /**
      * Solicita ingresar el uso de cada material
      * <b> Pre: La cantidad de materiales o productos ingresada por usuario (productsSize) y el Scanner creado (in).</b>
      * <b> Post: El uso de cada material.</b>
    ...
    /**
     * Solicita al usuario ingresar su localizacion
     * <b> Pre: El Scanner creado (in). </b>
     * <b> Post: Localizacion del usuario.</b>
     * @param in (Scanner)
     * @return
     */
    ...
    /**
     * Solicita ingresar los precios de los materiales en Homecenter
     * <b> Pre: La cantidad de materiales o productos ingresada (productsSize), nombres de los productos ingresados por usuario (String[] productsNames) y el Scanner creado (in). </b>
     * <b> Post: El valor de cada material en Homecenter. </b>
     * @param productsSize (int)
     ...
     * <b> Pre: La cantidad de materiales o productos ingresada (productsSize), nombres de los productos ingresados por usuario (String[] productsNames) y el Scanner creado (in). </b>
     * <b> Post: El valor de cada material en la ferreteria del centro. </b>
     * @param productsSize (int)
     ...
     * <b> Pre: La cantidad de materiales o productos ingresada (productsSize), nombres de los productos ingresados por usuario (String[] productsNames) y el Scanner creado (in). </b>
     * <b> Post: El valor de cada material en la ferreteria del barrio. </b>
     * @param productsSize (int)
     * @param productsNames (String[])
     * @param in (Scanner)
     * @return
    ...
    /**
     * Calcula el valor del domicio en Homecenter
     * <b> Pre: Precios de Homecenter ingresados por el usuario, cantidad de materiales o productos ingresados y localizacion del usuario ingresada. </b>
     * <b> Post: Valor del domicilio de cada producto en Homecenter. </b>
     * @param priceHomecenter (int[])
     * @param productsSize (int)
     * @param location (int)
     * @return (int[])
     */
    public static int[] calculateDomicileHomecenter(int[] priceHomecenter, int productsSize, int location) {
        int[] domicile = new int[productsSize];
    ...
    /**
     * Calcula el valor del domicio en la ferreteria del barrio
     * <b> Pre: Precios de la ferreteria del barrio ingresados por el usuario, cantidad de materiales ingresados y localizacion del usuario ingresada. </b>
     * <b> Post: Valor del domicilio de cada producto en la ferreteria del barrio. </b>
    ...
    public static int[] calculateDomicileNeighborhood(int[] priceNeighborhood, int productsSize, int location) {
        int[] domicile = new int[productsSize];
    ...
    /**
     * Calcula el valor del domicio en la ferreteria del centro
     * <b> Pre: Precios de la ferreteria del centro ingresados por el usuario, cantidad de materiales ingresados y localizacion del usuario ingresada. </b>
     * <b> Post: Valor del domicilio de cada producto en la ferreteria del centro. </b>
    ...
    public static int[] calculateDomicileDowntown(int[]  priceDowntown, int productsSize, int location) {
        int[] domicile = new int[productsSize];
    ...
    /**
     * Menu de condiciones respecto al menu de usuario
     * <b> Pre: Respuesta del menu ingresada y El Scanner llamado in creado. </b>
     * <b> Post: Respuesta del punto segun el menu de usurio. </b>
    ...
    public static void menuConditions(int menuAnswer,int productsSize,String[] productsNames, int[] productsAmount, int[] productsUseDestination,int[] priceDowntown, int[] priceHomecenter,int[] priceNeighborhood, int location,Scanner in) {
        boolean finished = false, materialsRegistered = false, pricesRegistered = false;
        ...
        while (finished != true) {
            if(menuAnswer == 1) {
                ...
                System.out.println("");
                System.out.println("El valor total a pagar cotizando en Homecenter es: "+(totalPriceHomecenter+ROUGH_CONSTRUCTION+WHITE_WORK+PAINTING)+"$ Pesos");
                System.out.println("");
                System.out.println("El valor total a pagar cotizando en la ferreteria del centro es: "+(totalPriceDowntown+ROUGH_CONSTRUCTION+WHITE_WORK+PAINTING)+"$ Pesos");
                System.out.println("");
                System.out.println("el valor total a pagar cotizando en la ferreteria del barrio es: "+(totalPriceNeighborhood+ROUGH_CONSTRUCTION+WHITE_WORK+PAINTING)+"$ Pesos");

            }else if (menuAnswer == 4) {
                
                for(int i=0;i<priceHomecenter.length;i++) {
                    for(int j=0;i<priceDowntown.length;i++) {
                        for(int k=0;k<priceNeighborhood.length;i++) {
